...
title = Label(text="pipGUI 3.0",font=("微软雅黑 Light",40),bg='#66ccff')
title.pack()
...
b5 = Button(text="升级指定包",font=("微软雅黑 Light",25),command=update_package,width=17,height=1,bg='#ffffff',bd=0)
b5.pack()
b6 = Button(text="查看pip版本",font=("微软雅黑 Light",25),command=get_pip_ver,width=17,height=1,bg='#ffffff',bd=0)
b6.pack()
b7 = Button(text="查看需更新的包",font=("微软雅黑 Light",25),command=cheak_package_update,width=17,height=1,bg='#ffffff',bd=0)
b7.pack()
root.mainloop()
